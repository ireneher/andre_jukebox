...
interior_naming = ("*_interior_*", "*_exposition_*")  # for interior get shader, for exposition get map (in prep)
shop_interior_map = {"*hop_interior_*": "am215_shop_interior_V1_SHDSG"}